  ...
  // "colorize" the widget name
      $.widget("flowchart.flowchart", {
          ...
          _create: function () {
              ...
              shape.setAttribute("stroke-dasharray", "1000");
          ...
          _clearLinksLayer: function () {
              ...
              this.objs.layers.operators.find('.flowchart-operator-connector-small-circle').css('border-left-color', 'transparent');
          },
          ...
          _refreshLinkPositions: function (linkId) {
              ...
              var bezierToX = toX + 1;
              var bezierIntensity = Math.min(100, Math.max(Math.abs(bezierFromX - bezierToX) / 4, Math.abs(fromY - toY)));
          ...
          _createSubConnector: function (connectorKey, connectorInfos, fullElement) {
              ...
              var $operator_connector_small_arrow = $('<div class="flowchart-operator-connector-small-circle"><svg id="owncircle"><circle r="5" stroke="black" stroke-width="0.5" fill="red" /></svg></div>');
  ...
  var operatorI = 0;
    $('#create_operator').click(function() {
      ...
      var operatorData = {
        ...
        left: 500,
        properties: {
          title: 'Yesh operator ' + (operatorI + 3),
          inputs: {
            input_1: {
              label: 'Input 1',
            }
      ...
      operatorI++; // incrementing the operator title
      // attaching the created operator to the example id
